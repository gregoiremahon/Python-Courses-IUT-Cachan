...
class cJoueur(): ## Classe joueur
    ...
    def verifierBaraque(self):
        if self.Valeurs[0] == self.Valeurs[1]:  # Comparaison des valeurs de la liste des valeurs de lancés de dés
            if self.Valeurs[1]==self.Valeurs[2]: # Si les dés du lancer ont la même valeur la méthode renvoie true
                return True # La méthode renvoie true
            else:
                return False # Sinon, elle renvoie false
    
    def verifier2as(self):
        if 1 in self.Valeurs:
            if self.Valeurs[0] == 1:
                if self.Valeurs[1] == 1:
                    return True
            if self.Valeurs[0] == 1:
...
print("Vérification 2 as donne ", Joueur.verifier2as())
print(Joueur.LancerLesDes())
print("Vérification 421 donne :", Joueur.verifier421())
print("Vérification Baraque donne :", Joueur.verifierBaraque())
print("Vérification 2 as donne ", Joueur.verifier2as())
